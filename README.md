...
bias random-walk weighting, stronger clamps, and adjacent `0.015`/`0.025` gyro
step sweeps were rejected by full-window evidence. The diagnostic plots still
