...
- Produced a curated official FAST-LIVO2 `Bright_Screen_Wall_curated_8s` baseline-vs-current report with trajectory and point-cloud gates passing while strict `CBD_Building_01` data remains quota-blocked.
